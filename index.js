...
function hungryDog(weight, age){
    ...
    if (age >= 1) {
      ...
      switch (true) {
        case age <= 4/12 && age >= 2/12:
          food = (weight * 0.1);
          break;
        case age <= 7/12 && age >= 4/12:
          food = (weight * 0.05);
          break;
        case age >= 7/12:
          food = (weight * 0.04);
...
for (let i = 0; i <= start; i++){
  console.log(annoyingSong(start - i))
}
...
let string2 = "thisisastring"

function vowelCounter(string2) {
  return(string2.match(/[aeiou]/gi).length)
}

console.log(vowelCounter(string2))
